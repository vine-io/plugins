...
func TestNewDialect(t *testing.T) {
	dao.DefaultDialect = postgres.NewDialect(dao.DSN("host=192.168.2.130 user=postgres password=123 dbname=mysite port=5432 sslmode=disable TimeZone=Asia/Shanghai"))
